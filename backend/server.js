...
//listar todas as quadras (com filtro opcional por esporte)
...
//cadastrar uma nova quadra (Para donos de quadras)
...
app.post("/api/bookings", async (req, res) => {
  const { court_id, user_name, user_phone, booking_date, booking_time } =
    req.body;
